package edu.viery.rojas.reto2.piramide.process;
...
La clase es el contenedor principal para el código y los datos que describen un objeto.
 ...
 Este ciclo for se ejecuta un número de veces igual a height  para imprimir cada fila del triángulo.
-----------------------------------------------------------------------------------------------------
 Ciclo for para imprimir los espacios:
 for (int space = height - row; space > 0; space--) {
 System.out.print(" ");
 }
 Este ciclo for se ejecuta un número de veces igual a height o row para imprimir los espacios en cada fila.
 -----------------------------------------------------------------------------------------------------
